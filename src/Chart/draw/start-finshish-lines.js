...
export function initStartFinishLines(app) {
   ...
   //Add the missing initialization for finishPrice
    finishPrice = new Graphics();
    finishPrice.alpha = 0.8;
    app.stage.addChild(finishPrice);
...
export function updateStartFinishLines(app, startFinish) {
    ...
    finishPrice.clear();
    finishPrice.beginFill(0x000000);
    finishPrice.drawCircle(
        finish.x,
        finish.y || -100,
        3
    );
